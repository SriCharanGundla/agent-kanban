...
class TestCreateAPIKey:
    ...
    async def test_create_api_key_success(
        ...
        assert len(data["key"]) == 67  # "ak_" + 64 hex chars
        assert "id" in data
    ...
    async def test_create_api_key_long_name(
        self, client: AsyncClient, auth_headers: dict[str, str]
    ):
    ...
    async def test_create_api_key_requires_jwt(
    ...
    async def test_create_multiple_api_keys(
        self, client: AsyncClient, auth_headers: dict[str, str]
    ):
...
class TestListAPIKeys:
    ...
    async def test_list_api_keys_success(
        ...
        from app.services.auth import generate_api_key, hash_api_key, extract_key_suffix
        ...
        for i in range(3):
            ...
            key_obj = ApiKey(
                ...
                key_suffix=extract_key_suffix(api_key),
    ...
    async def test_list_api_keys_excludes_revoked(
        ...
        key_obj1 = ApiKey(
            ...
            key_suffix=extract_key_suffix(api_key1),
        ...
        key_obj2 = ApiKey(
            ...
            key_suffix=extract_key_suffix(api_key2),
